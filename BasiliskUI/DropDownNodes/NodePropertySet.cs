...
namespace BasiliskNodesUI
{
    ...
    [NodeDescription("Set the property of a structural node object")]
    [NodeCategory("Basilisk.Structural.Node")]
    [NodeSearchable(true)]
    [NodeSearchTags("BH", "Buro", "Node", "Property", "Set")]
    [IsDesignScriptCompatible]
    public class NodePropertySet : DSDropDownBase
    {
        /// <summary>
        /// Set the inputs (InPorts)
        /// </summary>
        public NodePropertySet() : base("Property")
        {
            InPortData.Add(new PortData("node", "Input BHoM node object"));
            InPortData.Add(new PortData("property", "Input property object to set"));
            RegisterInputPorts();
        }
        /// <summary>
